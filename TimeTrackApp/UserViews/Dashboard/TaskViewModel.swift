...
class TaskViewModel: ObservableObject {
    @Published var storedTasks: [Task] = [
        ...
        Task(title: "Concert", description: "Fall Choir/Orchestra Concert", doneFlag: false, date: Date(timeInterval: 60*60*30, since: Date.now), index: 20),
        Task(title: "Music Social", description: "Music Department Halloween Social", doneFlag: false, date: Date(timeInterval: 60*60*30, since: Date.now), index: 21),
        Task(title: "Football Game", description: "Home Football Game vs. Tooele", doneFlag: false, date: Date(timeInterval: 60*60*30, since: Date.now), index: 22),
        Task(title: "Football Game", description: "Away Football Game vs. Stansbury", doneFlag: false, date: Date(timeInterval: 60*60*30, since: Date.now), index: 23),
        Task(title: "Football Game", description: "Home Football Game vs. Mountain View", doneFlag: false, date: Date(timeInterval: 60*60*30, since: Date.now), index: 24),
        Task(title: "Football Game", description: "Home Football Game vs. Pason", doneFlag: false, date: Date(timeInterval: 60*60*30, since: Date.now), index: 25),
        Task(title: "Football Game", description: "Away Football Game vs. Timpanogos", doneFlag: false, date: Date(timeInterval: 60*60*30, since: Date.now), index: 26),
        Task(title: "Cross Country", description: "Park City Invitational Quinn's Junction", doneFlag: false, date: Date(timeInterval: 60*60*30, since: Date.now), index: 27),
        Task(title: "Cross Country", description: "Border Wars Valley Regional Park", doneFlag: false, date: Date(timeInterval: 60*60*30, since: Date.now), index: 28),
        Task(title: "Cross Country", description: "Royal Run Roy High School", doneFlag: false, date: Date(timeInterval: 60*60*30, since: Date.now), index: 29),
        Task(title: "Cross Country", description: "Region VII Championships Cottonwood Complex", doneFlag: false, date: Date(timeInterval: 60*60*30, since: Date.now), index: 30),
        Task(title: "Threatre", description: "Shakespeare Competition", doneFlag: false, date: Date(timeInterval: 60*60*30, since: Date.now), index: 31),
        Task(title: "Threatre", description: "Shakespeare Competition", doneFlag: false, date: Date(timeInterval: 60*60*30, since: Date.now), index: 32),
        Task(title: "Threatre", description: "Shakespeare Competition", doneFlag: false, date: Date(timeInterval: 60*60*30, since: Date.now), index: 33)
